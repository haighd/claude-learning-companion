"""
CLC Trails - File path tracking and hotspot detection.

Helper module for laying trails in the CLC database.
Tracks which files are touched by tasks for hotspot analysis.
"""
...
def extract_file_paths(content: str) -> List[str]:
    ...
    Uses multiple regex patterns to find file paths in various formats:
    ...
    Returns a deduplicated list of extracted paths.
    """
...
def lay_trails(
    ...
    Args:
        file_paths: List of file paths to record
        outcome: Task outcome ('success', 'failure', 'unknown')
        agent_id: Optional agent identifier
        description: Optional description of the task

    Returns:
        Number of trails recorded
    """
    ...
    try:
        ...
        # Determine scent and strength based on outcome
