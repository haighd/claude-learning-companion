"""
CLC Security Patterns - Advisory verification patterns.

Centralized pattern definitions for AdvisoryVerifier.
Separated into its own file for easier editing and maintenance.
"""

# Risky patterns for advisory verification
# Format: (regex_pattern, warning_message)
RISKY_PATTERNS = {
    'code': [
...
PATTERN_CATEGORIES = list(RISKY_PATTERNS.keys())

# Total pattern count
TOTAL_PATTERNS = sum(len(patterns) for patterns in RISKY_PATTERNS.values())
