...
show_help() {
    ...
    echo "  --no-dashboard   Skip dashboard installation (skips visual UI at localhost:3001)"
    ...
    echo "  Dashboard: React UI for monitoring (localhost:3001)"
...
[ "$INSTALL_DASHBOARD" = true ] && echo -e "  ${GREEN}✓${NC} Dashboard (localhost:3001)"
